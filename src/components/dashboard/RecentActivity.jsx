...
const RecentActivity = () => {
    ...
    return (
        <div className="bg-white/70 backdrop-blur-xl border border-white/50 rounded-3xl p-6 shadow-xl shadow-gray-100/50 h-full flex flex-col">
            ...
            <div className="flex-1 space-y-6">
                {activities.map((item, index) => (
                    <div key={index} className="flex gap-4 group">
                        ...
                        <div className="pb-2">
                            <p className="font-medium text-gray-800 text-sm group-hover:text-pulsai-blue transition-colors cursor-pointer">{item.text}</p>
