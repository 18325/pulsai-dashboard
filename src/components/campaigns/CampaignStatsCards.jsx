...
import { TrendingUp, Mail, Eye, ShoppingCart, ArrowUpRight } from 'lucide-react';
...
export default function CampaignStatsCards({ stats }) {
    const cards = [
        ...
        },
        {
            ...
            value: stats.totalEmailsSent.toLocaleString('fr-FR'),
            icon: Mail,
            theme: 'green',
            trend: '+24%',
        },
        ...
        {
            title: 'Conversions',
            value: stats.conversions.toLocaleString('fr-FR'),
            icon: ShoppingCart,
            theme: 'gray',
            trend: '+16%',
        },
